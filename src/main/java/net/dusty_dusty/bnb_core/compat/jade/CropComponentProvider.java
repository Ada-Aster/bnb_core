...
public class CropComponentProvider implements IBlockComponentProvider {
    ...
    public static final ResourceLocation WIDGETS = ResourceLocation.fromNamespaceAndPath(BnbCore.MODID, "textures/gui/tooltip/widgets.png");
...
//            iTooltip.append(gauge);
    ...
    public ResourceLocation getUid() {
        return ResourceLocation.fromNamespaceAndPath(BnbCore.MODID, "temp_data");
    }
